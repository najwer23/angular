...
describe("UserListComponent", () => {
	...
	it("should unsubscribe from subscriptions on destroy", () => {
		(component as any).userSub = jasmine.createSpyObj("Subscription", [
			"unsubscribe",
		]);
		(component as any).wsSub = jasmine.createSpyObj("Subscription", [
			"unsubscribe",
		]);
		(component as any).favSub = jasmine.createSpyObj("Subscription", [
			"unsubscribe",
		]);
