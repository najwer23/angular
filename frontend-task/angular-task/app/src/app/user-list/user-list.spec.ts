...
describe('UserListComponent', () => {
  ...
  it('should apply filter correctly', () => {
    component.users = new MatTableDataSource<UserModel>([
        { id: 1, name: 'Bob', role: 'User', email: 'bob@example.com', protectedProjects: 1 },
        { id: 2, name: 'Alice', role: 'Admin', email: 'alice@example.com', protectedProjects: 3 },
    ]);
  ...
  it('should update users with favorites flag', () => {
    component.users = new MatTableDataSource<UserModel>([
      { id: 1, name: 'Alice', role: 'Admin', email: 'alice@example.com', protectedProjects: 3, fav: false },
      { id: 2, name: 'Bob', role: 'User', email: 'bob@example.com', protectedProjects: 1, fav: false }
    ]);
    component.favoriteUsers = [{ id: 1, name: 'Alice', role: 'Admin', email: 'alice@example.com', protectedProjects: 3 }];
  ...
  it('should dispatch user details and navigate on userDetails call', () => {
    ...
    const user: UserModel = { id: 1, name: 'Alice', role: 'Admin', email: 'alice@example.com', protectedProjects: 3 };
